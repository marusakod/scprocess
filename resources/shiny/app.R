...
metadata_combns      = yaml_data$metadata$metadata_combns
...
if (!is.null(metadata_combns)) {
  for (vars in metadata_combns) {
    cluster_meta = add_metadata_combns(cluster_meta, vars, vars_lvls[vars])
    sample_meta  = add_metadata_combns(sample_meta,  vars, vars_lvls[vars])
    cell_meta    = add_metadata_combns(cell_meta,    vars, vars_lvls[vars])
