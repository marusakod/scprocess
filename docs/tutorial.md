...
In this section we will run {{ software_name }} on a downsampled single nuclei dataset generated in this study: [Divergent single cell transcriptome and epigenome alterations in ALS and FTD patients with C9orf72 mutation](https://www.nature.com/articles/s41467-023-41033-y#data-availability). To be able to follow this tutorial make sure you completed all the steps in the [Getting started](setup.md) section.
