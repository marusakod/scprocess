...
In this section we will run {{ software_name }} on a small single nuclei dataset generated by downsampling the data in this study: [Divergent single cell transcriptome and epigenome alterations in ALS and FTD patients with C9orf72 mutation](https://www.nature.com/articles/s41467-023-41033-y#data-availability).
