...
AF_MITO_STR, AF_HOME_DIR, AF_INDEX_DIR, AF_GTF_DT_F, CHEMISTRY = \
  get_mapping_parameters(config, SCPROCESS_DATA_DIR, SPECIES)
...
HVG_METHOD, HVG_GROUP_VAR, HVG_CHUNK_SIZE, NUM_CHUNKS, GROUP_NAMES, CHUNK_NAMES, \
  N_HVGS, EXCLUDE_AMBIENT_GENES = \
...
MKR_SEL_RES, MKR_GSEA_DIR, MKR_MIN_CL_SIZE, MKR_MIN_CELLS, MKR_NOT_OK_RE, \
...
LBL_XGB_F, LBL_XGB_CLS_F, LBL_GENE_VAR, LBL_SEL_RES_CL, LBL_MIN_PRED, LBL_MIN_CL_PROP, \
  LBL_MIN_CL_SIZE, LBL_TISSUE = \
...
RETRIES, MB_RUN_MAPPING, MB_SAVE_ALEVIN_TO_H5, MB_RUN_AMBIENT, MB_GET_BARCODE_QC_METRICS, \
  MB_RUN_QC, MB_RUN_HVGS, MB_RUN_INTEGRATION, MB_MAKE_CLEAN_SCES, MB_RUN_MARKER_GENES, \
  MB_RENDER_HTMLS, MB_LABEL_CELLTYPES, MB_PB_MAKE_PBS, MB_PB_CALC_EMPTY_GENES, MB_MAKE_HTO_SCE_OBJECTS, \
  MB_MAKE_SUBSET_SCES =
