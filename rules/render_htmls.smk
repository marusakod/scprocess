...
rule render_html_mapping:
  ...
  shell: """
    ...
    template_f={scprocess_dir}/resources/rmd_templates/mapping.Rmd.template
    rule="mapping"
...
if config['multiplexing']['demux_type'] == "hto":
  ...
  rule render_html_multiplexing:
    ...
    shell: """
      ...
      template_f={scprocess_dir}/resources/rmd_templates/multiplexing.Rmd.template
      rule="multiplexing"
...
rule render_html_ambient:
  ...
  shell: """
    ...
    # define rule and template
    template_f={scprocess_dir}/resources/rmd_templates/ambient.Rmd.template
    rule="ambient"
...
rule render_html_qc:
  ...
  shell: """
    ...
    # define rule and template
    template_f={scprocess_dir}/resources/rmd_templates/SampleQC.Rmd.template
    rule="qc"
...
if CAN_CALC_AMBIENT_GENES:
  rule render_html_hvgs:
    ...
    shell: """
      ...
      # define rule and template
      template_f={scprocess_dir}/resources/rmd_templates/hvgs.Rmd.template
      rule="hvg"
...
if CELL_CYCLE_ENABLED:
  rule render_html_cell_cycle:
    ...
    shell: """
      exec &>> {log}
      cp {input.source_cell_cycle_f} {output.r_cell_cycle_f}
      template_f={input.template_f}
      Rscript --vanilla -e "source('{scprocess_dir}/scripts/render_htmls.R'); \
        render_html(
...
rule render_html_integration:
  ...
  shell: """
    ...
    # define rule and template
    template_f={scprocess_dir}/resources/rmd_templates/integration.Rmd.template
    rule="integration"
...
rule render_html_marker_genes:
  ...
  shell: """
    ...
    # define rule and template
    template_f={scprocess_dir}/resources/rmd_templates/marker_genes.Rmd.template
    rule="markers"
...
rule render_html_label_celltypes:
  ...
  shell: """
    ...
    template_f={scprocess_dir}/resources/rmd_templates/label_celltypes.Rmd.template
...
if TRAIN_XGB_PARAMS is not None:
  rule render_html_train_xgboost:
    ...
    shell: """
      ...
      cp {scprocess_dir}/scripts/train_xgboost.R {output.r_train_f}
