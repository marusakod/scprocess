...
# Input FASTA: >1 dna:chromosome chromosome:GRCm39:1:1:195471971:1 REF
# Output FASTA: >chr1 1
fasta_modified="genome.fa"  # Output file for the modified FASTA
cat "$fasta_in" \
    | sed -E 's/^>(\S+).*/>\1 \1/' \
...
gtf_filtered="genes.gtf"  # Final output file for filtered GTF
